...
public class PesqUser {
  ...
  // Bitmap foto_Bitmap_Utilizador;
   ...
   public PesqUser(String nome_Utilizador, String nome_Completo, String fotoemString) {
  ...
  /* public Bitmap getFoto_Bitmap_Utilizador() {
      return foto_Bitmap_Utilizador;
   }

   public void setFoto_Bitmap_Utilizador(Bitmap foto_Bitmap_Utilizador) {
      this.foto_Bitmap_Utilizador = foto_Bitmap_Utilizador;
   }*/
